...
@unlink(Mage::getBaseDir('var') . DIRECTORY_SEPARATOR . 'log' . DIRECTORY_SEPARATOR . 'meilisearch_dump.log');
...
function meilisearch_dump_log($message)
{
    Mage::log($message, null, 'meilisearch_dump.log', true);
}
