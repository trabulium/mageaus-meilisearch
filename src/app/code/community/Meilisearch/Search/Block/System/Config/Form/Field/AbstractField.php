...
abstract class Meilisearch_Search_Block_System_Config_Form_Field_AbstractField extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
     ...
     *
     * @return Meilisearch_Search_Block_System_Config_Form_Field_Select
     *
     * @throws Exception
     */
    protected function getRenderer($columnId, array $columnSettings)
    {
        ...
        /** @var Meilisearch_Search_Block_System_Config_Form_Field_Select $selectField */
        $selectField = Mage::app()->getLayout()->createBlock('meilisearch_search/system_config_form_field_select');
