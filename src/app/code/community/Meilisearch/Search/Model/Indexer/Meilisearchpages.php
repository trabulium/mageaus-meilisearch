...
class Meilisearch_Search_Model_Indexer_Meilisearchpages extends Meilisearch_Search_Model_Indexer_Abstract
{
    ...
    {
        return Mage::helper('meilisearch_search')->__('Meilisearch Search Pages');
    }
